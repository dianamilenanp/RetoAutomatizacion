...
public class ChoucairsRegisterPage  {
    ...
    public static final Target  SELECT_MONTH=Target.the("where do we select the month").located(By.xpath("//input[@id='birthMonth']"));
    public static final Target  SELECT_DAY=Target.the("where do we select the day").located(By.xpath("//input[@id='birthDay']"));
    public static final Target  SELECT_YEAR=Target.the("where do we select the year").located(By.xpath("//input[@id='birthYear']"));
